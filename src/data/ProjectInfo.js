...
export const Communique = {
    Title:'COMMUNIQUE',
    Name: 'Communique',
    Description: ' Web Application for wide Community of Employees within the organization to find relevant skilled colleagues or Projects within the organization to seek guidance in their own BAUs.',
    Points: [
...
export const Neo4j = {
    ...
    Description: 'Analysis of full lifecycle of the trade. From its point of origin till Settlement or Repair stage',
    Points: [
...
export const RtController = {
    ...
    Description: 'A Web app to automate the test scenario fro Regression Testing',
    Points: [
...
export const Mt599 = {
    ...
    Description: 'Analysis of free texts send by users to perform Analysis and find underlying patterns.',
    Points: [
...
export const ELKStack = {
    ...
    Description: 'Dynamic and Interactive Dashboards containing all the changes and incidents in the past ',
    Points: [
